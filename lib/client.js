...
function DecisionSettingsCard({ scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: "dsh-de-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "dsh-de-head", "aria-expanded": open, "aria-label": "\u51B3\u7B56\u5F15\u64CE\u8BBE\u7F6E", onClick: () => setOpen(!open), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-de-title", children: "\u51B3\u7B56\u5F15\u64CE" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-de-subtitle", children: "\u6709\u9650\u5019\u9009\u51B3\u7B56\u3001\u591A\u9636\u6BB5\u6267\u884C\u4E0E\u73AF\u5883\u63A5\u5165" })
      ] }),
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-de-body", children: [
      ...
      snapshot.status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        ...
        ["\u51B3\u7B56\u63D0\u4F9B\u65B9", "\u6A21\u578B\u9A7B\u7559", "\u6267\u884C\u9884\u7B97", "\u73AF\u5883"].map((group) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-de-group", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: group }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-de-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: !dirty || saving, onClick: () => {
            setDrafts({});
            editRevision.current = void 0;
            setError("");
          }, children: "\u653E\u5F03\u4FEE\u6539" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: !dirty || invalid || saving || !snapshot.writable, onClick: () => {
            void save();
