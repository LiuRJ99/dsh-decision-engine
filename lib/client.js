...
function DecisionSettingsCard({ scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-de-card", children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: "dsh-de-body", onSubmit: (event) => {
      ...
      snapshot.status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-de-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "dsh-de-label", htmlFor: "dsh-de-provider", children: "\u9ED8\u8BA4\u51B3\u7B56\u6A21\u578B" }),
