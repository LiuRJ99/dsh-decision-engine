...
export declare const DECISION_CONTROL_SKILL: {
    ...
    readonly description: "Use the decision layer: fast, low-latency choices over a finite candidate set, and single-step or bounded-loop control of a browser, desktop, or custom environment.";
