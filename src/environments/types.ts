...
export function okObservation(source: EnvironmentSource, state: unknown, extra?: Omit<Observation, 'status' | 'source' | 'state'>): Observation {
...
export function failedObservation(
  ...
  reason: string,
  extra?: Omit<Observation, 'status' | 'source' | 'reason'>,
): Observation {
